...
def main():
    ...
    myParameters = BOLDparameters.ParametersContinuous2D(
    ...
    mySimulation = BOLDsimulation.SimulationContinuous2D(
    ...
    signal, time_range, sim_time = mySimulation.signal_simulation('MonteCarlo', cplx=False, progressbar=True) #progressbar toggles the terminal progress monitoring
